...
function SessionModal({prop_display}) {
	const [display, setDisplay] = useState(prop_display);
		...
		<div className="modal" style={{display: display}}>
			<div className="modal-body">
				<div className="modal-bar">
					<a>Add Session</a>
					<div className="modal-close" onClick={() => setDisplay("none")}>
        ...
        render() {
                return (
									<>
										...
										<div className="flex">
											<div className="append_session" onClick={() => this.setState({modal: <SessionModal prop_display="flex"/>}) }>
